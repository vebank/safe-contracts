...
contract CompatibilityFallbackHandler is DefaultCallbackHandler, ISignatureValidator {
    ...
    function isValidSignature(bytes memory _data, bytes memory _signature) public view override returns (bytes4) {
        ...
        VeSafe safe = VeSafe(payable(msg.sender));
    ...
    function getMessageHash(bytes memory message) public view returns (bytes32) {
        return getMessageHashForSafe(VeSafe(payable(msg.sender)), message);
    }
    ...
    /// @param message Message that should be hashed
    /// @return Message hash.
    function getMessageHashForSafe(VeSafe safe, bytes memory message) public view returns (bytes32) {
     ...
     * @notice See https://github.com/Ve/util-contracts/blob/bb5fe5fb5df6d8400998094fb1b32a178a47c3a1/contracts/StorageAccessible.sol
     */
